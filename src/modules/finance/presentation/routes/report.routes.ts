...
router.get('/sales/by-category', authenticate, authorizeCompany, controller.getSalesByCategoryReport);
router.get('/sales/by-customer', authenticate, authorizeCompany, controller.getSalesByCustomerReport);
...
// ----------------------------------------------------
router.get('/finance/outstanding', authenticate, authorizeCompany, controller.getOutstandingInvoicesReport);
router.get('/finance/customer-statement', authenticate, authorizeCompany, controller.getCustomerStatementReport);
router.get('/finance/supplier-statement', authenticate, authorizeCompany, controller.getSupplierStatementReport);
...
router.get('/finance/profit-and-loss', authenticate, authorizeCompany, controller.getProfitAndLossReport);
router.get('/finance/profit-loss', authenticate, authorizeCompany, controller.getProfitAndLossReport);
router.get('/finance/vat-return', authenticate, authorizeCompany, controller.getVatReturnReport);
router.get('/finance/pro-commission', authenticate, authorizeCompany, controller.getProCommissionReport);
router.get('/finance/employee-performance', authenticate, authorizeCompany, controller.getEmployeePerformanceReport);
